# ====================================================================================
# Setup Project
PROJECT_NAME := provider-clusterbook
...
XPKGS = provider-clusterbook
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-clusterbook: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Clusterbook CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Clusterbook controllers
...
# This target prepares repo for your provider by replacing all "clusterbook"
